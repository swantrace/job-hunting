export const jobParserPromptVersion = '4.0.0'
...
- Do not infer or return a company, a job URL, or an application source. Those fields are deliberately user-provided.
...
- direction: choose the single best-fit direction id from the supplied available directions.
